/*
 * JS for L2SubmitSuggestionPage generated by Appery.io
 */
...
function L2SubmitSuggestionPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PopupLable1Name': 'L2SubmitSuggestionPage_PopupLable1Name'
    };
    ...
    Apperyio.CurrentScreen = 'L2SubmitSuggestionPage';
    ...
    // On Load
    var L2SubmitSuggestionPage_onLoad = function() {
            L2SubmitSuggestionPage_elementsExtraJS();

            L2SubmitSuggestionPage_deviceEvents();
            L2SubmitSuggestionPage_windowEvents();
            L2SubmitSuggestionPage_elementsEvents();
        };

    // screen window events


    function L2SubmitSuggestionPage_windowEvents() {

        $('#L2SubmitSuggestionPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#L2SubmitSuggestionPage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("L2SubmitSuggestionsPopup");
    ...
    function L2SubmitSuggestionPage_deviceEvents() {
    ...
    function L2SubmitSuggestionPage_elementsExtraJS() {
        // screen (L2SubmitSuggestionPage) extra code

        /* L2SubmitSuggestionsPopup */
        $("#L2SubmitSuggestionPage_L2SubmitSuggestionsPopup").popup("option", "positionTo", "window");
    ...
    function L2SubmitSuggestionPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#L2SubmitSuggestionPage").on("pagebeforeshow", "#L2SubmitSuggestionPage", function(event, ui) {
        Apperyio.CurrentScreen = "L2SubmitSuggestionPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    L2SubmitSuggestionPage_onLoad();
};

$(document).off("pagecreate", "#L2SubmitSuggestionPage").on("pagecreate", "#L2SubmitSuggestionPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    L2SubmitSuggestionPage_js();
});