/*
 * JS for XAdProfile001 generated by Appery.io
 */
...
function XAdProfile001_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobileimage_2': 'XAdProfile001_mobileimage_2'
    };
    ...
    Apperyio.CurrentScreen = 'XAdProfile001';
    ...
    // On Load
    var XAdProfile001_onLoad = function() {
            XAdProfile001_elementsExtraJS();

            XAdProfile001_deviceEvents();
            XAdProfile001_windowEvents();
            XAdProfile001_elementsEvents();
        };

    // screen window events


    function XAdProfile001_windowEvents() {

        $('#XAdProfile001').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdProfile001_deviceEvents() {
    ...
    function XAdProfile001_elementsExtraJS() {
        // screen (XAdProfile001) extra code
    ...
    function XAdProfile001_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdProfile001_mobilecontainer [name="mobileimage_2"]').on({
        ...
        }, '#XAdProfile001_mobilecontainer [name="mobileimage_2"]');

    };

    $(document).off("pagebeforeshow", "#XAdProfile001").on("pagebeforeshow", "#XAdProfile001", function(event, ui) {
        Apperyio.CurrentScreen = "XAdProfile001";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    XAdProfile001_onLoad();
};

$(document).off("pagecreate", "#XAdProfile001").on("pagecreate", "#XAdProfile001", function(event, ui) {
