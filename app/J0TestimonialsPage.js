/*
 * JS for J0TestimonialsPage generated by Appery.io
 */
...
function J0TestimonialsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'SubmitTestmonialsButtonName': 'J0TestimonialsPage_SubmitTestmonialsButtonName'
    };
    ...
    Apperyio.CurrentScreen = 'J0TestimonialsPage';
    ...
    // On Load
    var J0TestimonialsPage_onLoad = function() {
            J0TestimonialsPage_elementsExtraJS();

            J0TestimonialsPage_deviceEvents();
            J0TestimonialsPage_windowEvents();
            J0TestimonialsPage_elementsEvents();
        };

    // screen window events


    function J0TestimonialsPage_windowEvents() {

        $('#J0TestimonialsPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function J0TestimonialsPage_deviceEvents() {
    ...
    function J0TestimonialsPage_elementsExtraJS() {
        // screen (J0TestimonialsPage) extra code
    ...
    function J0TestimonialsPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#J0TestimonialsPage_J0TestimonialsHeadername [name="SubmitTestmonialsButtonName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio.navigateTo('J1SubmitTestimonialsPage', {
                        transition: 'slide',
                        reverse: false
                    });
        ...
        }, '#J0TestimonialsPage_J0TestimonialsHeadername [name="SubmitTestmonialsButtonName"]');

    };

    $(document).off("pagebeforeshow", "#J0TestimonialsPage").on("pagebeforeshow", "#J0TestimonialsPage", function(event, ui) {
        Apperyio.CurrentScreen = "J0TestimonialsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    J0TestimonialsPage_onLoad();
};

$(document).off("pagecreate", "#J0TestimonialsPage").on("pagecreate", "#J0TestimonialsPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    J0TestimonialsPage_js();
});