/*
 * JS for XAdProfile003 generated by Appery.io
 */
...
function XAdProfile003_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobileimage_4': 'XAdProfile003_mobileimage_4'
    };
    ...
    Apperyio.CurrentScreen = 'XAdProfile003';
    ...
    // On Load
    var XAdProfile003_onLoad = function() {
            XAdProfile003_elementsExtraJS();

            XAdProfile003_deviceEvents();
            XAdProfile003_windowEvents();
            XAdProfile003_elementsEvents();
        };

    // screen window events


    function XAdProfile003_windowEvents() {

        $('#XAdProfile003').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdProfile003_deviceEvents() {
    ...
    function XAdProfile003_elementsExtraJS() {
        // screen (XAdProfile003) extra code
    ...
    function XAdProfile003_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdProfile003_mobilecontainer [name="mobileimage_4"]').on({
        ...
        }, '#XAdProfile003_mobilecontainer [name="mobileimage_4"]');

    };

    $(document).off("pagebeforeshow", "#XAdProfile003").on("pagebeforeshow", "#XAdProfile003", function(event, ui) {
        Apperyio.CurrentScreen = "XAdProfile003";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    XAdProfile003_onLoad();
};

$(document).off("pagecreate", "#XAdProfile003").on("pagecreate", "#XAdProfile003", function(event, ui) {
