/*
 * JS for XAdDialog09 generated by Appery.io
 */
...
function XAdDialog09_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog09_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog09';
    ...
    // On Load
    var XAdDialog09_onLoad = function() {
            XAdDialog09_elementsExtraJS();

            XAdDialog09_deviceEvents();
            XAdDialog09_windowEvents();
            XAdDialog09_elementsEvents();
        };

    // screen window events


    function XAdDialog09_windowEvents() {

        $('#XAdDialog09').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog09_deviceEvents() {
    ...
    function XAdDialog09_elementsExtraJS() {
        // screen (XAdDialog09) extra code
    ...
    function XAdDialog09_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog09_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog09_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog09").on("pagebeforeshow", "#XAdDialog09", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog09";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog09").on("pagecreate", "#XAdDialog09", function(event, ui) {
