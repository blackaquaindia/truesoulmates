/*
 * JS for D2EditProfilePage generated by Appery.io
 */
...
function D2EditProfilePage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PopupLable1Name': 'D2EditProfilePage_PopupLable1Name'
    };
    ...
    Apperyio.CurrentScreen = 'D2EditProfilePage';
    ...
    // On Load
    var D2EditProfilePage_onLoad = function() {
            D2EditProfilePage_elementsExtraJS();

            D2EditProfilePage_deviceEvents();
            D2EditProfilePage_windowEvents();
            D2EditProfilePage_elementsEvents();
        };

    // screen window events


    function D2EditProfilePage_windowEvents() {

        $('#D2EditProfilePage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#D2EditProfilePage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("D2EditProfilePopupName");
    ...
    function D2EditProfilePage_deviceEvents() {
    ...
    function D2EditProfilePage_elementsExtraJS() {
        // screen (D2EditProfilePage) extra code

        /* D2EditProfilePopupName */
        $("#D2EditProfilePage_D2EditProfilePopupName").popup("option", "positionTo", "window");
    ...
    function D2EditProfilePage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#D2EditProfilePage").on("pagebeforeshow", "#D2EditProfilePage", function(event, ui) {
        Apperyio.CurrentScreen = "D2EditProfilePage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    D2EditProfilePage_onLoad();
};

$(document).off("pagecreate", "#D2EditProfilePage").on("pagecreate", "#D2EditProfilePage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    D2EditProfilePage_js();
});