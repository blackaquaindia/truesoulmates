/*
 * JS for XAdDialog08 generated by Appery.io
 */
...
function XAdDialog08_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog08_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog08';
    ...
    // On Load
    var XAdDialog08_onLoad = function() {
            XAdDialog08_elementsExtraJS();

            XAdDialog08_deviceEvents();
            XAdDialog08_windowEvents();
            XAdDialog08_elementsEvents();
        };

    // screen window events


    function XAdDialog08_windowEvents() {

        $('#XAdDialog08').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog08_deviceEvents() {
    ...
    function XAdDialog08_elementsExtraJS() {
        // screen (XAdDialog08) extra code
    ...
    function XAdDialog08_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog08_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog08_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog08").on("pagebeforeshow", "#XAdDialog08", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog08";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog08").on("pagecreate", "#XAdDialog08", function(event, ui) {
