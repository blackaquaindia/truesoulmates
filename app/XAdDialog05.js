/*
 * JS for XAdDialog05 generated by Appery.io
 */
...
function XAdDialog05_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog05_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog05';
    ...
    // On Load
    var XAdDialog05_onLoad = function() {
            XAdDialog05_elementsExtraJS();

            XAdDialog05_deviceEvents();
            XAdDialog05_windowEvents();
            XAdDialog05_elementsEvents();
        };

    // screen window events


    function XAdDialog05_windowEvents() {

        $('#XAdDialog05').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog05_deviceEvents() {
    ...
    function XAdDialog05_elementsExtraJS() {
        // screen (XAdDialog05) extra code
    ...
    function XAdDialog05_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog05_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog05_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog05").on("pagebeforeshow", "#XAdDialog05", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog05";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog05").on("pagecreate", "#XAdDialog05", function(event, ui) {
