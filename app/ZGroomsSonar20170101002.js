/*
 * JS for ZGroomsSonar20170101002 generated by Appery.io
 */
...
function ZGroomsSonar20170101002_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PrintButtonName': 'ZGroomsSonar20170101002_PrintButtonName',
        'ProfilePrintImageName': 'ZGroomsSonar20170101002_ProfilePrintImageName',
        'KundaliPrintImageName': 'ZGroomsSonar20170101002_KundaliPrintImageName'
    };
    ...
    Apperyio.CurrentScreen = 'ZGroomsSonar20170101002';
    ...
    // On Load
    var ZGroomsSonar20170101002_onLoad = function() {
            ZGroomsSonar20170101002_elementsExtraJS();

            ZGroomsSonar20170101002_deviceEvents();
            ZGroomsSonar20170101002_windowEvents();
            ZGroomsSonar20170101002_elementsEvents();
        };

    // screen window events


    function ZGroomsSonar20170101002_windowEvents() {

        $('#ZGroomsSonar20170101002').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#ZGroomsSonar20170101002').on({
    ...
    function ZGroomsSonar20170101002_deviceEvents() {
    ...
    function ZGroomsSonar20170101002_elementsExtraJS() {
        // screen (ZGroomsSonar20170101002) extra code

        /* PrintPopupName */
        $("#ZGroomsSonar20170101002_PrintPopupName").popup("option", "positionTo", "window");
    ...
    function ZGroomsSonar20170101002_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#ZGroomsSonar20170101002_ZGroomsSonar20170101002HeaderName [name="PrintButtonName"]').on({
        ...
        }, '#ZGroomsSonar20170101002_ZGroomsSonar20170101002HeaderName [name="PrintButtonName"]');

        $(document).off("click", '#ZGroomsSonar20170101002_PrintPopupName [name="ProfilePrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
        ...
        }, '#ZGroomsSonar20170101002_PrintPopupName [name="ProfilePrintImageName"]');
        $(document).off("click", '#ZGroomsSonar20170101002_PrintPopupName [name="KundaliPrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio('PrintPopupName').popup('close');
        ...
        }, '#ZGroomsSonar20170101002_PrintPopupName [name="KundaliPrintImageName"]');

    };

    $(document).off("pagebeforeshow", "#ZGroomsSonar20170101002").on("pagebeforeshow", "#ZGroomsSonar20170101002", function(event, ui) {
        Apperyio.CurrentScreen = "ZGroomsSonar20170101002";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    ZGroomsSonar20170101002_onLoad();
};

$(document).off("pagecreate", "#ZGroomsSonar20170101002").on("pagecreate", "#ZGroomsSonar20170101002", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    ZGroomsSonar20170101002_js();
});