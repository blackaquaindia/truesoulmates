/*
 * JS for H0NewsPage generated by Appery.io
 */
...
function H0NewsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'SubmitNewsButtonName': 'H0NewsPage_SubmitNewsButtonName'
    };
    ...
    Apperyio.CurrentScreen = 'H0NewsPage';
    ...
    // On Load
    var H0NewsPage_onLoad = function() {
            H0NewsPage_elementsExtraJS();

            H0NewsPage_deviceEvents();
            H0NewsPage_windowEvents();
            H0NewsPage_elementsEvents();
        };

    // screen window events


    function H0NewsPage_windowEvents() {

        $('#H0NewsPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function H0NewsPage_deviceEvents() {
    ...
    function H0NewsPage_elementsExtraJS() {
        // screen (H0NewsPage) extra code
    ...
    function H0NewsPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#H0NewsPage_H0NewsHeaderName [name="SubmitNewsButtonName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio.navigateTo('H1SubmitNewsPage', {
                        transition: 'slide',
                        reverse: false
                    });
        ...
        }, '#H0NewsPage_H0NewsHeaderName [name="SubmitNewsButtonName"]');

    };

    $(document).off("pagebeforeshow", "#H0NewsPage").on("pagebeforeshow", "#H0NewsPage", function(event, ui) {
        Apperyio.CurrentScreen = "H0NewsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#H0NewsPage").on("pagecreate", "#H0NewsPage", function(event, ui) {
