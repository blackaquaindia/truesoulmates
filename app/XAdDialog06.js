/*
 * JS for XAdDialog06 generated by Appery.io
 */
...
function XAdDialog06_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog06_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog06';
    ...
    // On Load
    var XAdDialog06_onLoad = function() {
            XAdDialog06_elementsExtraJS();

            XAdDialog06_deviceEvents();
            XAdDialog06_windowEvents();
            XAdDialog06_elementsEvents();
        };

    // screen window events


    function XAdDialog06_windowEvents() {

        $('#XAdDialog06').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog06_deviceEvents() {
    ...
    function XAdDialog06_elementsExtraJS() {
        // screen (XAdDialog06) extra code
    ...
    function XAdDialog06_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog06_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog06_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog06").on("pagebeforeshow", "#XAdDialog06", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog06";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog06").on("pagecreate", "#XAdDialog06", function(event, ui) {
