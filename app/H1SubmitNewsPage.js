/*
 * JS for H1SubmitNewsPage generated by Appery.io
 */
...
function H1SubmitNewsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PopupLable1Name': 'H1SubmitNewsPage_PopupLable1Name'
    };
    ...
    Apperyio.CurrentScreen = 'H1SubmitNewsPage';
    ...
    // On Load
    var H1SubmitNewsPage_onLoad = function() {
            H1SubmitNewsPage_elementsExtraJS();

            H1SubmitNewsPage_deviceEvents();
            H1SubmitNewsPage_windowEvents();
            H1SubmitNewsPage_elementsEvents();
        };

    // screen window events


    function H1SubmitNewsPage_windowEvents() {

        $('#H1SubmitNewsPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#H1SubmitNewsPage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("H1SubmitNewsPopupName");
    ...
    function H1SubmitNewsPage_deviceEvents() {
    ...
    function H1SubmitNewsPage_elementsExtraJS() {
        // screen (H1SubmitNewsPage) extra code

        /* H1SubmitNewsPopupName */
        $("#H1SubmitNewsPage_H1SubmitNewsPopupName").popup("option", "positionTo", "window");
    ...
    function H1SubmitNewsPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#H1SubmitNewsPage").on("pagebeforeshow", "#H1SubmitNewsPage", function(event, ui) {
        Apperyio.CurrentScreen = "H1SubmitNewsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    H1SubmitNewsPage_onLoad();
};

$(document).off("pagecreate", "#H1SubmitNewsPage").on("pagecreate", "#H1SubmitNewsPage", function(event, ui) {
