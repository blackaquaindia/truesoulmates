/*
 * JS for B0AboutUsPage generated by Appery.io
 */
...
function B0AboutUsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'EnglishAboutUsName': 'B0AboutUsPage_EnglishAboutUsName',
        'MarathiAboutUsName': 'B0AboutUsPage_MarathiAboutUsName',
        'HindiAboutUsName': 'B0AboutUsPage_HindiAboutUsName',
        'GujaratiAboutUsName': 'B0AboutUsPage_GujaratiAboutUsName'
    };
    ...
    Apperyio.CurrentScreen = 'B0AboutUsPage';
    ...
    // On Load
    var B0AboutUsPage_onLoad = function() {
            B0AboutUsPage_elementsExtraJS();

            B0AboutUsPage_deviceEvents();
            B0AboutUsPage_windowEvents();
            B0AboutUsPage_elementsEvents();
        };

    // screen window events


    function B0AboutUsPage_windowEvents() {

        $('#B0AboutUsPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function B0AboutUsPage_deviceEvents() {
    ...
    function B0AboutUsPage_elementsExtraJS() {
        // screen (B0AboutUsPage) extra code
    ...
    function B0AboutUsPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#B0AboutUsPage").on("pagebeforeshow", "#B0AboutUsPage", function(event, ui) {
        Apperyio.CurrentScreen = "B0AboutUsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    B0AboutUsPage_onLoad();
};

$(document).off("pagecreate", "#B0AboutUsPage").on("pagecreate", "#B0AboutUsPage", function(event, ui) {
