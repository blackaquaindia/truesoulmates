/*
 * JS for L3TermsandConditionsPage generated by Appery.io
 */
...
function L3TermsandConditionsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'EnglishTermsandConditionsName': 'L3TermsandConditionsPage_EnglishTermsandConditionsName',
        'MarathiTermsandConditionsName': 'L3TermsandConditionsPage_MarathiTermsandConditionsName',
        'HindiTermsandConditionsName': 'L3TermsandConditionsPage_HindiTermsandConditionsName',
        'GujaratiTermsandConditionsName': 'L3TermsandConditionsPage_GujaratiTermsandConditionsName',
        'PopupLable1Name': 'L3TermsandConditionsPage_PopupLable1Name'
    };
    ...
    Apperyio.CurrentScreen = 'L3TermsandConditionsPage';
    ...
    // On Load
    var L3TermsandConditionsPage_onLoad = function() {
            L3TermsandConditionsPage_elementsExtraJS();

            L3TermsandConditionsPage_deviceEvents();
            L3TermsandConditionsPage_windowEvents();
            L3TermsandConditionsPage_elementsEvents();
        };

    // screen window events


    function L3TermsandConditionsPage_windowEvents() {

        $('#L3TermsandConditionsPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#L3TermsandConditionsPage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("L3TermsandConditionsPopup");
    ...
    function L3TermsandConditionsPage_deviceEvents() {
    ...
    function L3TermsandConditionsPage_elementsExtraJS() {
        // screen (L3TermsandConditionsPage) extra code

        /* L3TermsandConditionsPopup */
        $("#L3TermsandConditionsPage_L3TermsandConditionsPopup").popup("option", "positionTo", "window");
    ...
    function L3TermsandConditionsPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#L3TermsandConditionsPage").on("pagebeforeshow", "#L3TermsandConditionsPage", function(event, ui) {
        Apperyio.CurrentScreen = "L3TermsandConditionsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    L3TermsandConditionsPage_onLoad();
};

$(document).off("pagecreate", "#L3TermsandConditionsPage").on("pagecreate", "#L3TermsandConditionsPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    L3TermsandConditionsPage_js();
});