/*
 * JS for F0ContactsPage generated by Appery.io
 */
...
function F0ContactsPage_js() {
    ...
    Apperyio.CurrentScreen = 'F0ContactsPage';
    ...
    // On Load
    var F0ContactsPage_onLoad = function() {
            F0ContactsPage_elementsExtraJS();

            F0ContactsPage_deviceEvents();
            F0ContactsPage_windowEvents();
            F0ContactsPage_elementsEvents();
        };

    // screen window events


    function F0ContactsPage_windowEvents() {

        $('#F0ContactsPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function F0ContactsPage_deviceEvents() {
    ...
    function F0ContactsPage_elementsExtraJS() {
        // screen (F0ContactsPage) extra code
    ...
    function F0ContactsPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#F0ContactsPage").on("pagebeforeshow", "#F0ContactsPage", function(event, ui) {
        Apperyio.CurrentScreen = "F0ContactsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    F0ContactsPage_onLoad();
};

$(document).off("pagecreate", "#F0ContactsPage").on("pagecreate", "#F0ContactsPage", function(event, ui) {
