/*
 * JS for G0EventsPage generated by Appery.io
 */
...
function G0EventsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'SubmitEventsButtonName': 'G0EventsPage_SubmitEventsButtonName'
    };
    ...
    Apperyio.CurrentScreen = 'G0EventsPage';
    ...
    // On Load
    var G0EventsPage_onLoad = function() {
            G0EventsPage_elementsExtraJS();

            G0EventsPage_deviceEvents();
            G0EventsPage_windowEvents();
            G0EventsPage_elementsEvents();
        };

    // screen window events


    function G0EventsPage_windowEvents() {

        $('#G0EventsPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function G0EventsPage_deviceEvents() {
    ...
    function G0EventsPage_elementsExtraJS() {
        // screen (G0EventsPage) extra code
    ...
    function G0EventsPage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#G0EventsPage_G0EventsHeaderName [name="SubmitEventsButtonName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio.navigateTo('G1SubmitEventsPage', {
                        transition: 'slide',
                        reverse: false
                    });
        ...
        }, '#G0EventsPage_G0EventsHeaderName [name="SubmitEventsButtonName"]');

    };

    $(document).off("pagebeforeshow", "#G0EventsPage").on("pagebeforeshow", "#G0EventsPage", function(event, ui) {
        Apperyio.CurrentScreen = "G0EventsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#G0EventsPage").on("pagecreate", "#G0EventsPage", function(event, ui) {
