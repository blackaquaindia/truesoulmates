/*
 * JS for ZGroomsSonar20170101003 generated by Appery.io
 */
...
function ZGroomsSonar20170101003_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PrintButtonName': 'ZGroomsSonar20170101003_PrintButtonName',
        'ProfilePrintImageName': 'ZGroomsSonar20170101003_ProfilePrintImageName',
        'KundaliPrintImageName': 'ZGroomsSonar20170101003_KundaliPrintImageName'
    };
    ...
    Apperyio.CurrentScreen = 'ZGroomsSonar20170101003';
    ...
    // On Load
    var ZGroomsSonar20170101003_onLoad = function() {
            ZGroomsSonar20170101003_elementsExtraJS();

            ZGroomsSonar20170101003_deviceEvents();
            ZGroomsSonar20170101003_windowEvents();
            ZGroomsSonar20170101003_elementsEvents();
        };

    // screen window events


    function ZGroomsSonar20170101003_windowEvents() {

        $('#ZGroomsSonar20170101003').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#ZGroomsSonar20170101003').on({
    ...
    function ZGroomsSonar20170101003_deviceEvents() {
    ...
    function ZGroomsSonar20170101003_elementsExtraJS() {
        // screen (ZGroomsSonar20170101003) extra code

        /* PrintPopupName */
        $("#ZGroomsSonar20170101003_PrintPopupName").popup("option", "positionTo", "window");
    ...
    function ZGroomsSonar20170101003_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#ZGroomsSonar20170101003_ZGroomsSonar20170101003HeaderName [name="PrintButtonName"]').on({
        ...
        }, '#ZGroomsSonar20170101003_ZGroomsSonar20170101003HeaderName [name="PrintButtonName"]');

        $(document).off("click", '#ZGroomsSonar20170101003_PrintPopupName [name="ProfilePrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
        ...
        }, '#ZGroomsSonar20170101003_PrintPopupName [name="ProfilePrintImageName"]');
        $(document).off("click", '#ZGroomsSonar20170101003_PrintPopupName [name="KundaliPrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio('PrintPopupName').popup('close');
        ...
        }, '#ZGroomsSonar20170101003_PrintPopupName [name="KundaliPrintImageName"]');

    };

    $(document).off("pagebeforeshow", "#ZGroomsSonar20170101003").on("pagebeforeshow", "#ZGroomsSonar20170101003", function(event, ui) {
        Apperyio.CurrentScreen = "ZGroomsSonar20170101003";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    ZGroomsSonar20170101003_onLoad();
};

$(document).off("pagecreate", "#ZGroomsSonar20170101003").on("pagecreate", "#ZGroomsSonar20170101003", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    ZGroomsSonar20170101003_js();
});