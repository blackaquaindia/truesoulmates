/*
 * JS for D0RegisterSoulmatePage generated by Appery.io
 */
...
function D0RegisterSoulmatePage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'EnglishCreateProfileButtonName': 'D0RegisterSoulmatePage_EnglishCreateProfileButtonName',
        'EnglishEditProfileButtonName': 'D0RegisterSoulmatePage_EnglishEditProfileButtonName',
        'EnglishDeleteProfileButtonName': 'D0RegisterSoulmatePage_EnglishDeleteProfileButtonName',
        'PopupLable1Name': 'D0RegisterSoulmatePage_PopupLable1Name',
        'PopupLable2Name': 'D0RegisterSoulmatePage_PopupLable2Name',
        'PopupLable3Name': 'D0RegisterSoulmatePage_PopupLable3Name'
    };
    ...
    Apperyio.CurrentScreen = 'D0RegisterSoulmatePage';
    ...
    // On Load
    var D0RegisterSoulmatePage_onLoad = function() {
            D0RegisterSoulmatePage_elementsExtraJS();

            D0RegisterSoulmatePage_deviceEvents();
            D0RegisterSoulmatePage_windowEvents();
            D0RegisterSoulmatePage_elementsEvents();
        };

    // screen window events


    function D0RegisterSoulmatePage_windowEvents() {

        $('#D0RegisterSoulmatePage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#D0RegisterSoulmatePage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("D0RegisterSoulmatePopup");
    ...
    function D0RegisterSoulmatePage_deviceEvents() {
    ...
    function D0RegisterSoulmatePage_elementsExtraJS() {
        // screen (D0RegisterSoulmatePage) extra code

        /* D0RegisterSoulmatePopup */
        $("#D0RegisterSoulmatePage_D0RegisterSoulmatePopup").popup("option", "positionTo", "window");
    ...
    function D0RegisterSoulmatePage_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#D0RegisterSoulmatePage_D0RegisterSoulmateContainerName [name="EnglishCreateProfileButtonName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio.navigateTo('D1CreateProfilePage', {
                        transition: 'slide',
                        reverse: false
                    });
        ...
        }, '#D0RegisterSoulmatePage_D0RegisterSoulmateContainerName [name="EnglishCreateProfileButtonName"]');
        $(document).off("click", '#D0RegisterSoulmatePage_D0RegisterSoulmateContainerName [name="EnglishEditProfileButtonName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio.navigateTo('D2EditProfilePage', {
                        transition: 'slide',
                        reverse: false
                    });
        ...
        }, '#D0RegisterSoulmatePage_D0RegisterSoulmateContainerName [name="EnglishEditProfileButtonName"]');
        $(document).off("click", '#D0RegisterSoulmatePage_D0RegisterSoulmateContainerName [name="EnglishDeleteProfileButtonName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio.navigateTo('D3DeleteProfilePage', {
                        transition: 'slide',
                        reverse: false
                    });
        ...
        }, '#D0RegisterSoulmatePage_D0RegisterSoulmateContainerName [name="EnglishDeleteProfileButtonName"]');

    };

    $(document).off("pagebeforeshow", "#D0RegisterSoulmatePage").on("pagebeforeshow", "#D0RegisterSoulmatePage", function(event, ui) {
        Apperyio.CurrentScreen = "D0RegisterSoulmatePage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    D0RegisterSoulmatePage_onLoad();
};

$(document).off("pagecreate", "#D0RegisterSoulmatePage").on("pagecreate", "#D0RegisterSoulmatePage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    D0RegisterSoulmatePage_js();
});