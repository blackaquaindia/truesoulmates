/*
 * JS for XAdDialog04 generated by Appery.io
 */
...
function XAdDialog04_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog04_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog04';
    ...
    // On Load
    var XAdDialog04_onLoad = function() {
            XAdDialog04_elementsExtraJS();

            XAdDialog04_deviceEvents();
            XAdDialog04_windowEvents();
            XAdDialog04_elementsEvents();
        };

    // screen window events


    function XAdDialog04_windowEvents() {

        $('#XAdDialog04').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog04_deviceEvents() {
    ...
    function XAdDialog04_elementsExtraJS() {
        // screen (XAdDialog04) extra code
    ...
    function XAdDialog04_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog04_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog04_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog04").on("pagebeforeshow", "#XAdDialog04", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog04";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog04").on("pagecreate", "#XAdDialog04", function(event, ui) {
