/*
 * JS for XAdDialog07 generated by Appery.io
 */
...
function XAdDialog07_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog07_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog07';
    ...
    // On Load
    var XAdDialog07_onLoad = function() {
            XAdDialog07_elementsExtraJS();

            XAdDialog07_deviceEvents();
            XAdDialog07_windowEvents();
            XAdDialog07_elementsEvents();
        };

    // screen window events


    function XAdDialog07_windowEvents() {

        $('#XAdDialog07').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog07_deviceEvents() {
    ...
    function XAdDialog07_elementsExtraJS() {
        // screen (XAdDialog07) extra code
    ...
    function XAdDialog07_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog07_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog07_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog07").on("pagebeforeshow", "#XAdDialog07", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog07";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog07").on("pagecreate", "#XAdDialog07", function(event, ui) {
