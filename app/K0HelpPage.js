/*
 * JS for K0HelpPage generated by Appery.io
 */
...
function K0HelpPage_js() {
    ...
    Apperyio.CurrentScreen = 'K0HelpPage';
    ...
    // On Load
    var K0HelpPage_onLoad = function() {
            K0HelpPage_elementsExtraJS();

            K0HelpPage_deviceEvents();
            K0HelpPage_windowEvents();
            K0HelpPage_elementsEvents();
        };

    // screen window events


    function K0HelpPage_windowEvents() {

        $('#K0HelpPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function K0HelpPage_deviceEvents() {
    ...
    function K0HelpPage_elementsExtraJS() {
        // screen (K0HelpPage) extra code
    ...
    function K0HelpPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#K0HelpPage").on("pagebeforeshow", "#K0HelpPage", function(event, ui) {
        Apperyio.CurrentScreen = "K0HelpPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#K0HelpPage").on("pagecreate", "#K0HelpPage", function(event, ui) {
