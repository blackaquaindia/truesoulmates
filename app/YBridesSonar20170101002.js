/*
 * JS for YBridesSonar20170101002 generated by Appery.io
 */
...
function YBridesSonar20170101002_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PrintButtonName': 'YBridesSonar20170101002_PrintButtonName',
        'ProfilePrintImageName': 'YBridesSonar20170101002_ProfilePrintImageName',
        'KundaliPrintImageName': 'YBridesSonar20170101002_KundaliPrintImageName'
    };
    ...
    Apperyio.CurrentScreen = 'YBridesSonar20170101002';
    ...
    // On Load
    var YBridesSonar20170101002_onLoad = function() {
            YBridesSonar20170101002_elementsExtraJS();

            YBridesSonar20170101002_deviceEvents();
            YBridesSonar20170101002_windowEvents();
            YBridesSonar20170101002_elementsEvents();
        };

    // screen window events


    function YBridesSonar20170101002_windowEvents() {

        $('#YBridesSonar20170101002').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#YBridesSonar20170101002').on({
            pagehide: function(event) {
                Apperyio.navigateTo('XAdProfile002', {
                    transition: 'pop'
                });
            },
        });
    ...
    function YBridesSonar20170101002_deviceEvents() {
    ...
    function YBridesSonar20170101002_elementsExtraJS() {
        // screen (YBridesSonar20170101002) extra code

        /* PrintPopupName */
        $("#YBridesSonar20170101002_PrintPopupName").popup("option", "positionTo", "window");
    ...
    function YBridesSonar20170101002_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#YBridesSonar20170101002_YBridesSonar20170101002HeaderName [name="PrintButtonName"]').on({
        ...
        }, '#YBridesSonar20170101002_YBridesSonar20170101002HeaderName [name="PrintButtonName"]');

        $(document).off("click", '#YBridesSonar20170101002_PrintPopupName [name="ProfilePrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
        ...
        }, '#YBridesSonar20170101002_PrintPopupName [name="ProfilePrintImageName"]');
        $(document).off("click", '#YBridesSonar20170101002_PrintPopupName [name="KundaliPrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio('PrintPopupName').popup('close');
        ...
        }, '#YBridesSonar20170101002_PrintPopupName [name="KundaliPrintImageName"]');

    };

    $(document).off("pagebeforeshow", "#YBridesSonar20170101002").on("pagebeforeshow", "#YBridesSonar20170101002", function(event, ui) {
        Apperyio.CurrentScreen = "YBridesSonar20170101002";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    YBridesSonar20170101002_onLoad();
};

$(document).off("pagecreate", "#YBridesSonar20170101002").on("pagecreate", "#YBridesSonar20170101002", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    YBridesSonar20170101002_js();
});