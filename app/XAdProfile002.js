/*
 * JS for XAdProfile002 generated by Appery.io
 */
...
function XAdProfile002_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobileimage_3': 'XAdProfile002_mobileimage_3'
    };
    ...
    Apperyio.CurrentScreen = 'XAdProfile002';
    ...
    // On Load
    var XAdProfile002_onLoad = function() {
            XAdProfile002_elementsExtraJS();

            XAdProfile002_deviceEvents();
            XAdProfile002_windowEvents();
            XAdProfile002_elementsEvents();
        };

    // screen window events


    function XAdProfile002_windowEvents() {

        $('#XAdProfile002').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdProfile002_deviceEvents() {
    ...
    function XAdProfile002_elementsExtraJS() {
        // screen (XAdProfile002) extra code
    ...
    function XAdProfile002_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdProfile002_mobilecontainer [name="mobileimage_3"]').on({
        ...
        }, '#XAdProfile002_mobilecontainer [name="mobileimage_3"]');

    };

    $(document).off("pagebeforeshow", "#XAdProfile002").on("pagebeforeshow", "#XAdProfile002", function(event, ui) {
        Apperyio.CurrentScreen = "XAdProfile002";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    XAdProfile002_onLoad();
};

$(document).off("pagecreate", "#XAdProfile002").on("pagecreate", "#XAdProfile002", function(event, ui) {
