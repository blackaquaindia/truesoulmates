/*
 * JS for XAdDialog03 generated by Appery.io
 */
...
function XAdDialog03_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog03_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog03';
    ...
    // On Load
    var XAdDialog03_onLoad = function() {
            XAdDialog03_elementsExtraJS();

            XAdDialog03_deviceEvents();
            XAdDialog03_windowEvents();
            XAdDialog03_elementsEvents();
        };

    // screen window events


    function XAdDialog03_windowEvents() {

        $('#XAdDialog03').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog03_deviceEvents() {
    ...
    function XAdDialog03_elementsExtraJS() {
        // screen (XAdDialog03) extra code
    ...
    function XAdDialog03_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog03_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog03_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog03").on("pagebeforeshow", "#XAdDialog03", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog03";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog03").on("pagecreate", "#XAdDialog03", function(event, ui) {
