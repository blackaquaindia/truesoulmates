/*
 * JS for XAdDialog11 generated by Appery.io
 */
...
function XAdDialog11_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog11_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog11';
    ...
    // On Load
    var XAdDialog11_onLoad = function() {
            XAdDialog11_elementsExtraJS();

            XAdDialog11_deviceEvents();
            XAdDialog11_windowEvents();
            XAdDialog11_elementsEvents();
        };

    // screen window events


    function XAdDialog11_windowEvents() {

        $('#XAdDialog11').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog11_deviceEvents() {
    ...
    function XAdDialog11_elementsExtraJS() {
        // screen (XAdDialog11) extra code
    ...
    function XAdDialog11_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog11_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog11_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog11").on("pagebeforeshow", "#XAdDialog11", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog11";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog11").on("pagecreate", "#XAdDialog11", function(event, ui) {
