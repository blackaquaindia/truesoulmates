/*
 * JS for G1SubmitEventsPage generated by Appery.io
 */
...
function G1SubmitEventsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PopupLable1Name': 'G1SubmitEventsPage_PopupLable1Name'
    };
    ...
    Apperyio.CurrentScreen = 'G1SubmitEventsPage';
    ...
    // On Load
    var G1SubmitEventsPage_onLoad = function() {
            G1SubmitEventsPage_elementsExtraJS();

            G1SubmitEventsPage_deviceEvents();
            G1SubmitEventsPage_windowEvents();
            G1SubmitEventsPage_elementsEvents();
        };

    // screen window events


    function G1SubmitEventsPage_windowEvents() {

        $('#G1SubmitEventsPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#G1SubmitEventsPage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("G1SubmitEventsPopup");
    ...
    function G1SubmitEventsPage_deviceEvents() {
    ...
    function G1SubmitEventsPage_elementsExtraJS() {
        // screen (G1SubmitEventsPage) extra code

        /* G1SubmitEventsPopup */
        $("#G1SubmitEventsPage_G1SubmitEventsPopup").popup("option", "positionTo", "window");
    ...
    function G1SubmitEventsPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#G1SubmitEventsPage").on("pagebeforeshow", "#G1SubmitEventsPage", function(event, ui) {
        Apperyio.CurrentScreen = "G1SubmitEventsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    G1SubmitEventsPage_onLoad();
};

$(document).off("pagecreate", "#G1SubmitEventsPage").on("pagecreate", "#G1SubmitEventsPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    G1SubmitEventsPage_js();
});