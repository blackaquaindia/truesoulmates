/*
 * JS for XAdDialog01 generated by Appery.io
 */
...
function XAdDialog01_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog01_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog01';
    ...
    // On Load
    var XAdDialog01_onLoad = function() {
            XAdDialog01_elementsExtraJS();

            XAdDialog01_deviceEvents();
            XAdDialog01_windowEvents();
            XAdDialog01_elementsEvents();
        };

    // screen window events


    function XAdDialog01_windowEvents() {

        $('#XAdDialog01').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog01_deviceEvents() {
    ...
    function XAdDialog01_elementsExtraJS() {
        // screen (XAdDialog01) extra code
    ...
    function XAdDialog01_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog01_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog01_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog01").on("pagebeforeshow", "#XAdDialog01", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog01";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog01").on("pagecreate", "#XAdDialog01", function(event, ui) {
