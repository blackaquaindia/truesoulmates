/*
 * JS for J1SubmitTestimonialsPage generated by Appery.io
 */
...
function J1SubmitTestimonialsPage_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PopupLable1Name': 'J1SubmitTestimonialsPage_PopupLable1Name'
    };
    ...
    Apperyio.CurrentScreen = 'J1SubmitTestimonialsPage';
    ...
    // On Load
    var J1SubmitTestimonialsPage_onLoad = function() {
            J1SubmitTestimonialsPage_elementsExtraJS();

            J1SubmitTestimonialsPage_deviceEvents();
            J1SubmitTestimonialsPage_windowEvents();
            J1SubmitTestimonialsPage_elementsEvents();
        };

    // screen window events


    function J1SubmitTestimonialsPage_windowEvents() {

        $('#J1SubmitTestimonialsPage').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#J1SubmitTestimonialsPage').on({
            pageshow: function(event) {
                var popupElement = Apperyio("J1TestimonialsPopupName");
    ...
    function J1SubmitTestimonialsPage_deviceEvents() {
    ...
    function J1SubmitTestimonialsPage_elementsExtraJS() {
        // screen (J1SubmitTestimonialsPage) extra code

        /* J1TestimonialsPopupName */
        $("#J1SubmitTestimonialsPage_J1TestimonialsPopupName").popup("option", "positionTo", "window");
    ...
    function J1SubmitTestimonialsPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#J1SubmitTestimonialsPage").on("pagebeforeshow", "#J1SubmitTestimonialsPage", function(event, ui) {
        Apperyio.CurrentScreen = "J1SubmitTestimonialsPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    J1SubmitTestimonialsPage_onLoad();
};

$(document).off("pagecreate", "#J1SubmitTestimonialsPage").on("pagecreate", "#J1SubmitTestimonialsPage", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    J1SubmitTestimonialsPage_js();
});