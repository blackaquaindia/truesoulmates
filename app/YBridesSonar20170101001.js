/*
 * JS for YBridesSonar20170101001 generated by Appery.io
 */
...
function YBridesSonar20170101001_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'PrintButtonName': 'YBridesSonar20170101001_PrintButtonName',
        'ProfilePrintImageName': 'YBridesSonar20170101001_ProfilePrintImageName',
        'KundaliPrintImageName': 'YBridesSonar20170101001_KundaliPrintImageName'
    };
    ...
    Apperyio.CurrentScreen = 'YBridesSonar20170101001';
    ...
    // On Load
    var YBridesSonar20170101001_onLoad = function() {
            YBridesSonar20170101001_elementsExtraJS();

            YBridesSonar20170101001_deviceEvents();
            YBridesSonar20170101001_windowEvents();
            YBridesSonar20170101001_elementsEvents();
        };

    // screen window events


    function YBridesSonar20170101001_windowEvents() {

        $('#YBridesSonar20170101001').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
        $('#YBridesSonar20170101001').on({
    ...
    function YBridesSonar20170101001_deviceEvents() {
    ...
    function YBridesSonar20170101001_elementsExtraJS() {
        // screen (YBridesSonar20170101001) extra code

        /* PrintPopupName */
        $("#YBridesSonar20170101001_PrintPopupName").popup("option", "positionTo", "window");
    ...
    function YBridesSonar20170101001_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#YBridesSonar20170101001_YBridesSonar20170101001HeaderName [name="PrintButtonName"]').on({
        ...
        }, '#YBridesSonar20170101001_YBridesSonar20170101001HeaderName [name="PrintButtonName"]');

        $(document).off("click", '#YBridesSonar20170101001_PrintPopupName [name="ProfilePrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
        ...
        }, '#YBridesSonar20170101001_PrintPopupName [name="ProfilePrintImageName"]');
        $(document).off("click", '#YBridesSonar20170101001_PrintPopupName [name="KundaliPrintImageName"]').on({
            click: function(event) {
                if (!$(this).attr('disabled')) {
                    Apperyio('PrintPopupName').popup('close');
        ...
        }, '#YBridesSonar20170101001_PrintPopupName [name="KundaliPrintImageName"]');

    };

    $(document).off("pagebeforeshow", "#YBridesSonar20170101001").on("pagebeforeshow", "#YBridesSonar20170101001", function(event, ui) {
        Apperyio.CurrentScreen = "YBridesSonar20170101001";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    YBridesSonar20170101001_onLoad();
};

$(document).off("pagecreate", "#YBridesSonar20170101001").on("pagecreate", "#YBridesSonar20170101001", function(event, ui) {
    Apperyio.processSelectMenu($(this));
    YBridesSonar20170101001_js();
});