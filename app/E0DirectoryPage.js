/*
 * JS for E0DirectoryPage generated by Appery.io
 */
...
function E0DirectoryPage_js() {
    ...
    Apperyio.CurrentScreen = 'E0DirectoryPage';
    ...
    // On Load
    var E0DirectoryPage_onLoad = function() {
            E0DirectoryPage_elementsExtraJS();

            E0DirectoryPage_deviceEvents();
            E0DirectoryPage_windowEvents();
            E0DirectoryPage_elementsEvents();
        };

    // screen window events


    function E0DirectoryPage_windowEvents() {

        $('#E0DirectoryPage').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function E0DirectoryPage_deviceEvents() {
    ...
    function E0DirectoryPage_elementsExtraJS() {
        // screen (E0DirectoryPage) extra code
    ...
    function E0DirectoryPage_elementsEvents() {
    ...
    $(document).off("pagebeforeshow", "#E0DirectoryPage").on("pagebeforeshow", "#E0DirectoryPage", function(event, ui) {
        Apperyio.CurrentScreen = "E0DirectoryPage";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
    ...
    E0DirectoryPage_onLoad();
};

$(document).off("pagecreate", "#E0DirectoryPage").on("pagecreate", "#E0DirectoryPage", function(event, ui) {
