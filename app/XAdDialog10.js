/*
 * JS for XAdDialog10 generated by Appery.io
 */
...
function XAdDialog10_js() {

    /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'XAdDialogImageName': 'XAdDialog10_XAdDialogImageName'
    };
    ...
    Apperyio.CurrentScreen = 'XAdDialog10';
    ...
    // On Load
    var XAdDialog10_onLoad = function() {
            XAdDialog10_elementsExtraJS();

            XAdDialog10_deviceEvents();
            XAdDialog10_windowEvents();
            XAdDialog10_elementsEvents();
        };

    // screen window events


    function XAdDialog10_windowEvents() {

        $('#XAdDialog10').bind('pageshow orientationchange', function() {
            var _page = this;
    ...
    function XAdDialog10_deviceEvents() {
    ...
    function XAdDialog10_elementsExtraJS() {
        // screen (XAdDialog10) extra code
    ...
    function XAdDialog10_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });

        $(document).off("click", '#XAdDialog10_XAdDialogContainerName [name="XAdDialogImageName"]').on({
        ...
        }, '#XAdDialog10_XAdDialogContainerName [name="XAdDialogImageName"]');

    };

    $(document).off("pagebeforeshow", "#XAdDialog10").on("pagebeforeshow", "#XAdDialog10", function(event, ui) {
        Apperyio.CurrentScreen = "XAdDialog10";
        _.chain(Apperyio.mappings).filter(function(m) {
            return m.homeScreen === Apperyio.CurrentScreen;
        }).each(Apperyio.UIHandler.hideTemplateComponents);
...
$(document).off("pagecreate", "#XAdDialog10").on("pagecreate", "#XAdDialog10", function(event, ui) {
